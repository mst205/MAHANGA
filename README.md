# MAHANGA
MĀHANGA: Model Ānalysis: Handling biNary Grids VisuAlisation - designed for use with Aotearoa STARS
...
PLEASE NOTE I am not a data/computer scientist, and my coding skills are questionable at best. As it currently is, MĀHANGA requires a certain file structure, and the functions are very messy. There are alot of imporvements to be made but this is a start.
